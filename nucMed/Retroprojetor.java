...
public class Retroprojetor {
	...
	/**
	 * Método para fazer view 90 sem correcão de atenuação
	 * 
	 * @param sinopixels
	 *            array float com os valores da imagem
	 */
	...
	/**
	 * Método para fazer view 180 sem correcão de atenuação
	 * 
	 * @param sinopixels
	 *            array float com os valores da imagem
	 */
	...
	/**
	 * Método para fazer view 270 sem correcão de atenuação
	 * 
	 * @param sinopixels
	 *            array float com os valores da imagem
	 */
	...
	/**
	 * Método para fazer view zero com correcão de atenuação
	 * 
	 * @param mapa
	...
	/**
	 * Método para fazer view 90 com correcão de atenuação
	 * 
	 * @param mapa
	 *            array float com os valores do mapa de atenuação
	 * @param imgpixels
	...
	/**
	 * Método para fazer view 180 com correcão de atenuação
	 * 
	 * @param mapa
	 *            array float com os valores do mapa de atenuação
	 * @param imgpixels
	...
	/**
	 * Método para fazer view 270 com correcão de atenuação
	 * 
	 * @param mapa
	 *            array float com os valores do mapa de atenuação
	 * @param img
